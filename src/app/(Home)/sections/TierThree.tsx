...
import ModalPayThree from "./ModalPayThree";
    ...
    <div className="mt-5">
      <div>
        ...
        <ul className="text-sm">
          <li>
            ● Established businesses with consistent revenue streams looking to
            maintain leadership and innovate.
          </li>
          <li>
            ● Companies aiming for market expansion, new product development, or
        ...
        <ul className="text-sm">
          ...
          <li>
            ...
            <ul>
              <li>
                Ongoing training programs for staff (e.g., leadership, customer
                service, wellness integration).
              </li>
            </ul>
          </li>
          <li>
          ...
          <li>
            ...
            <ul>
              <li>
                Detailed quarterly and annual reports tracking progress, ROI,
