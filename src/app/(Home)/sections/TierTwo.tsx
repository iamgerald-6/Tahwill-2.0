...
import ModalProceedPayTwo from "./ModalProceedPayTwo";
...
const TierTwo = () => {
  ...
  return (
    <div className="mt-5">
      <div>
        <h2 className="text-lg font-bold">Full-Scale Business Development</h2>
        <p className="text-sm">
          This tier is designed for businesses ready to scale, refine their
          operations, and expand their market reach. It provides comprehensive
          support for strategic growth, helping you achieve long-term success
          with a hands-on approach.
        </p>
        <h3 className="mt-4 text-lg font-bold">Who It’s For</h3>
        <ul className="text-sm">
          <li>
            ● Growing businesses looking to scale operations or expand into new
            markets.
          </li>
          <li>
            ● Companies that need help with branding, marketing, or operational
            efficiency.
          </li>
        ...
        <ul className="text-sm">
          <li>
            ...
            <ul>
              ...
              <li>Customer insights report (based on surveys or reviews).</li>
            ...
            <ul>
              <li>
                ...
                <ul>
                  ...
                  <li>
                    Financial planning (e.g., cost optimization, revenue growth
                    strategies).
                  </li>
                </ul>
              </li>
          ...
          <li>
            ...
            <ul>
              <li>
                Assistance with executing selected strategies (e.g., rebranding,
                launching campaigns, process optimization).
              </li>
              <li>
          ...
          <li>
            ...
            <ul>
              <li>
                Up to 2 customized training sessions (e.g., branding, customer
          ...
          <li>
            ...
            <ul>
              <li>
                Monthly or bi-weekly updates with performance tracking (e.g.,
          ...
          <li>
            ...
            <ul>
              <li>
                Templates for business operations, marketing plans, or financial
                tracking.
              </li>
              <li>
                Access to analytics or project management tools (if applicable).
              </li>
            </ul>
          </li>
        </ul>
