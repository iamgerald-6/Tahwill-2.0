   ...
   return (
     <>
       <div>
         ...
         {/* About Section */}
         <div className="px-24 grid md:grid-cols-2 mt-20">
           <div className="text-lg text-primary flex flex-col justify-center">
             <h3 className="text-2xl ">Who We Are</h3>
             <p className="mt-3">
               We are a female-led holistic wellness company that provides
               personalized health consulting, business development services,
               and wellness education for individuals, wellness entrepreneurs,
         ...
         <div className="bg-primary/20 grid md:grid-cols-2 mt-5">
           <div className=" px-24 text-lg text-primary flex flex-col justify-center">
         ...
         <div className="bg-primary-100/20 md:flex justify-center sm:px-16 px-6 items-center py-10">
           ...
           <div className="pt-20 md:px-10 md:pl-20 px-3 pb-6 md:w-[70%] text-primary">
             <h3
             ...
             <div className="grid gap-5 mt-7">
               <p className="text-sm">
                 At Tahwil, we believe wellness is a shared responsibility.
                 That’s why we’re building Africa’s first fully integrated
                 wellness ecosystem, a collaborative platform that supports
                 connection, resource sharing, and long-term impact. Our vision
                 is bold: to bring African wellness to the global stage,
                 reviving indigenous knowledge and shaping a new blueprint for
                 how the world heals and thrives
               </p>
             </div>
           </div>
         </div>
       ...
       <div className="m-0">
         <div className="grid lg:grid-cols-2   ">
           <div className="pt-20 md:px-20 px-6 lg:pb-0 pb-6">
             <h3
             ...
             <div className="grid gap-6 mt-6 text-primary">
               ...
               >
                 ...
                 transformative journeys and fostering holistic well-being
       ...
       <div className="m-0 text-primary ">
         <div className="grid lg:grid-cols-2 bg-primary/25">
           <div className=" pt-10 md:px-20 px-6 lg:pb-0 pb-6">
             <h3
               // initial={{ opacity: 0, y: 50 }}
               // whileInView={{ opacity: 1, y: 0 }}
               // transition={{ duration: 0.6, ease: "easeOut" }}
             ...
             <div className="grid gap-6 mt-3 ">
               {visionArr?.map((vision) => (
                 ...
                 >
                   ...
                   <p className="text-xs ">{vision?.desc}</p>
                 </div>
               ))}
             </div>
           </div>
